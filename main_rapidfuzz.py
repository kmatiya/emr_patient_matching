...
# --- 5. Compute Similarity Features with RapidFuzz ---
def string_similarity(a, b):
    # Using token_sort_ratio (0-100), convert to 0-1 scale
...
matched_df.to_csv('../matched_patients_rapid_fuzz.csv', index=False)
print(f"✅ Matching complete. {len(matched_df)} matches saved to 'matched_patients_rapid_fuzz.csv'.")
